...
export default function Elitefit() {
  ...
  return (
    <div className='container-fluid' style={{ width: "100%", height: "40px", backgroundColor: "black", gap: "10px" }}>
      ...
      <div className="row">
        <div className="col-md-6 image1" style={{ height: "600px", backgroundColor: "grey" }}></div>
        <div className="col-md-6 image2" style={{ height: "600px", backgroundColor: "black" }}></div>
        <div className="col-md-6 image3" style={{ height: "600px", backgroundColor: "black" }}></div>
        <div className="col-md-6 image4" style={{ height: "600px", backgroundColor: "grey" }}></div>
        <div className="col-md-6 image5" style={{ height: "600px", backgroundColor: "black" }}></div>
        <div className="col-md-6 image6" style={{ height: "600px", backgroundColor: "grey" }}></div>
      </div>
